...
3. Write a commit message: one subject line (≤72 chars) + blank line + bullet list of changes. Always append `Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>`.
